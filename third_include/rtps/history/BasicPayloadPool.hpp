...
namespace detail {
#include <rtps/history/BasicPayloadPool_impl/Base.hpp>

#include <rtps/history/BasicPayloadPool_impl/Dynamic.hpp>
#include <rtps/history/BasicPayloadPool_impl/DynamicReusable.hpp>
#include <rtps/history/BasicPayloadPool_impl/Preallocated.hpp>
#include <rtps/history/BasicPayloadPool_impl/PreallocatedWithRealloc.hpp>
}  // namespace detail
