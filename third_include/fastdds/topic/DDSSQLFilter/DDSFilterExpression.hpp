...
#include <fastdds/topic/DDSSQLFilter/DDSFilterCondition.hpp>
#include <fastdds/topic/DDSSQLFilter/DDSFilterField.hpp>
#include <fastdds/topic/DDSSQLFilter/DDSFilterParameter.hpp>
