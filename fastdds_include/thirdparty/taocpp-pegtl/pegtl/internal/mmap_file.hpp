...
#include <thirdparty/taocpp-pegtl/pegtl/internal/mmap_file_posix.hpp>
#elif defined( _WIN32 )
#include <thirdparty/taocpp-pegtl/pegtl/internal/mmap_file_win32.hpp>
#else
#endif

#include <thirdparty/taocpp-pegtl/pegtl/internal/filesystem.hpp>
